...
import BoxTextoFichaCariacica from "../components/Cariacica/BoxTextoFicha/BoxTextoFicha";
import GaleriaCariacica from "../components/Cariacica/Galeria/Galeria";
...
export default function Serra() {
 ...
 Saiba Mais */}
      ...
      <AspectRatio maxW="100%" ratio={9 / 3}>
         <iframe
            src="https://www.youtube.com/embed/mI1TFkFm0i0"
